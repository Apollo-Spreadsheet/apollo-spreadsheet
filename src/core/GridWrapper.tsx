...
const GridWrapper = forwardRef((props: Props, componentRef: any) => {
																																			...
																																			const openEditor = (
																																				...
																																				if (!column) {
																																					return console.error(
																																						'Column not found at index ' + colIndex,
																																					)
																																				}
																																			...
																																			const cellRenderer = useCallback(
																																				({
																																					...
																																					const cell =
																																						props.rows[rowIndex]?.[columnIndex]
																																			...
																																			const onRefMount = useCallback(
																																				instance => {
																																					...
																																					if (
																																						props.onGridReady &&
																																						(componentRef as any).current
																																					) {
																																						props.onGridReady(
																																							(componentRef as any).current as IGridApi,
																																						)
																																					}
