    ...
    const cellMeasurerWrapperRenderer = useCallback(
      (args) => {
        ...
        const style = {
          ...args.style,
          ...cell["style"],
          width: cell.width ?? args.parent.props.columnWidth,
          userSelect: "none",
        };
        // console.log({
        //   argsStyle: args.style,
        //   cellStyle: cell["style"],
        //   width: cell.width ?? args.parent.props.columnWidth,
        //   cellDefaultWidth: cell.width,
        //   parentColWidth: args.parent.props.columnWidth,
        // });
        const rendererProps = {
          ...args,
          cell,
