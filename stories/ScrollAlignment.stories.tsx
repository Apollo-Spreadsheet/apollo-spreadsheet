...
const ExampleTable = ({ headerData, stretchMode, overrideRows, scrollToAlignment }: ExampleTableProps) => {
...
storiesOf('Scroll Alignment', module).add('Auto (default)', () => {
...
.add('Center', () => {
  ...
  return <ExampleTable headerData={headers} stretchMode={StretchMode.All} scrollToAlignment={'center'} />
})
.add('Start', () => {
  const headers: Column[] = [
    createColumnMock({ width: '20%', title: 'Id', accessor: 'id' }),
  ...
  return <ExampleTable headerData={headers} stretchMode={StretchMode.All} scrollToAlignment={'start'} />
})
.add('End', () => {
  const headers: Column[] = [
    createColumnMock({ width: '20%', title: 'Id', accessor: 'id' }),
  ...
  return <ExampleTable headerData={headers} stretchMode={StretchMode.All} scrollToAlignment={'end'} />
})